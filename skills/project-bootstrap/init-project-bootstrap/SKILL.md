...
description: 当用户提及“代码仓初始化”“初始化代码仓”“初始化目录”“初始化项目结构”“初始化项目文档路径”“初始化 Codex 持续开发工作流”或明确要求执行 `/init` 命令时触发。用于在当前项目目录创建 AGENTS.md、ARCHITECTURE.md 与 docs 分层目录及持续开发工作流基础文档；若目标文件或目录已存在则直接跳过，严禁覆盖已有内容，且不执行具体需求开发。
---
